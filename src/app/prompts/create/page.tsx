...
import { MetricBadge, EvaluationTable, PromotionDecisionBanner, DiffViewer } from "@/components/prompts";
...
export default function CreatePromptPage() {
  ...
  useEffect(() => {
    if (selectedParentName) {
      ...
      setParentVersions([]);
      setFormData({ ...formData, parent_version_id: undefined });
    }
  }, [selectedParentName]);
  ...
  const handleEvaluate = async () => {
    ...
    try {
      ...
      const errorMessage = error.message || error.data?.detail || "Failed to evaluate prompt";
      toast({
        title: "Error",
  ...
  const handleImprove = async () => {
    ...
    try {
      ...
      const errorMessage = error.message || error.data?.detail || "Failed to improve prompt";
      toast({
        title: "Error",
